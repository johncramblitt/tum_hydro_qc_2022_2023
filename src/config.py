...
VENTED_CORRECTED_HEADER = ['date_time(UTC:PDT+7)', 'vented_pressure(cm)', 'water_temperature(deg_C)','special_conductivity(microSiemens)' ,'discharge_flag']
...
NO_FLOW_LEVEL = {0 : 1.9383, 1 : 0.189547, 2 : 0.218727, 3 : 0.7639, 4 : None, 5 : None}